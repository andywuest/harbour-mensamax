...
public:
  ...
  Q_INVOKABLE void executeLogin(const QString &project, const QString &location,
  ...
  Q_INVOKABLE void executeGetMenus(const QString &token,
                                   const int weekOffset); // TODO dates
  Q_INVOKABLE void executeSubscribeMeal(const QString &token,
                                        const long lunchId);
  Q_INVOKABLE void executeUnsubscribeMeal(const QString &token,
                                          const long lunchId);
